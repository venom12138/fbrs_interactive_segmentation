...
#                                         max_iou_thr=TARGET_IOU, max_clicks=EVAL_MAX_CLICKS, clicks=sample['click_list'])
#     pred_mask = pred > MODEL_THRESH
#     draw = vis.draw_with_blend_and_clicks(sample['image'], mask=pred_mask, clicks_list=clicks_list)
#     mask = np.concatenate((255 * pred_mask[:, :, np.newaxis].repeat(3, axis=2)), axis=1) # 
...
pos_clicks = [[161, 268], [143, 259], [130, 273], [119, 303], [146, 299], [155, 319], [182, 291], [181, 243], [201, 211], [141, 205], [129, 222], [224, 233], [151, 277], [126, 357], [119, 342], [19, 8], [27, 14]]
neg_clicks = [[216, 193], [142, 219], [212, 221], [192, 240], [201, 272], [190, 310], [193, 337], [165, 318], [163, 356], [151, 326], [134, 357], [112, 311], [113, 255], [108, 379], [23, 12], [16, 10]]
clicks_list, ious_arr, pred = evaluate_sample(image, None, predictor, 
